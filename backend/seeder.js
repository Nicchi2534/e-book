...
const sampleBooks = [
  // THRILLER
  { 
    title: 'The Silent Patient', author: 'Alex Michaelides', category: 'Thriller', rating: 4.5, numReviews: 1245, views: 15400, price: 9.99, isTrending: true, 
  ...
  // SELF-HELP
  { 
    title: 'Atomic Habits', author: 'James Clear', category: 'Self-Help', rating: 4.9, numReviews: 3200, views: 120500, price: 14.99, isTrending: true, 
  ...
  { 
    title: 'The Subtle Art of Not Giving a F*ck', author: 'Mark Manson', category: 'Self-Help', rating: 4.6, numReviews: 29000, views: 340000, price: 12.99, isTrending: true, 
  ...
  // TECHNOLOGY
  { 
    title: 'Clean Code', author: 'Robert C. Martin', category: 'Technology', rating: 4.7, numReviews: 950, views: 54000, price: 19.99, isTrending: false, 
    coverImage: '/books/4.jpg', 
    description: "Even bad code can function. But if code isn't clean, it can bring a development organization to its knees..." 
  },
  { 
    title: 'The Pragmatic Programmer', author: 'David Thomas', category: 'Technology', rating: 4.8, numReviews: 12000, views: 95000, price: 29.99, isTrending: true, 
  ...
  // FICTION
  { 
    title: 'The Great Gatsby', author: 'F. Scott Fitzgerald', category: 'Fiction', rating: 4.6, numReviews: 5400, views: 245000, price: 6.99, isTrending: true, 
  ...
  { 
    title: 'To Kill a Mockingbird', author: 'Harper Lee', category: 'Fiction', rating: 4.9, numReviews: 8100, views: 405000, price: 8.99, isTrending: false, 
  ...
  { 
    title: 'Harry Potter and the Sorcerer\'s Stone', author: 'J.K. Rowling', category: 'Fiction', rating: 4.9, numReviews: 15400, views: 560000, price: 10.99, isTrending: true, 
  ...
  { 
    title: 'The Alchemist', author: 'Paulo Coelho', category: 'Fiction', rating: 4.7, numReviews: 8500, views: 230000, price: 8.99, isTrending: false, 
  ...
  // BUSINESS
  { 
    title: 'The Lean Startup', author: 'Eric Ries', category: 'Business', rating: 4.6, numReviews: 2900, views: 76000, price: 12.99, isTrending: false, 
  ...
  // BIOGRAPHY
  { 
    title: 'Steve Jobs', author: 'Walter Isaacson', category: 'Biography', rating: 4.8, numReviews: 4100, views: 120000, price: 15.99, isTrending: false, 
  ...
  { 
    title: 'Becoming', author: 'Michelle Obama', category: 'Biography', rating: 4.9, numReviews: 65000, views: 800000, price: 18.99, isTrending: true, 
  ...
  { 
    title: 'Educated', author: 'Tara Westover', category: 'Biography', rating: 4.8, numReviews: 42000, views: 650000, price: 11.99, isTrending: false, 
